...
namespace MagicaCloth
{
    ...
    public class ClothParams
    {
        ...
        [SerializeField]
        private BezierParam penetrationConnectDistance = new BezierParam(0.2f, 0.3f, true, 0.0f, false);
        //[SerializeField]
        //private BezierParam penetrationStiffness = new BezierParam(1.0f, 1.0f, false, 0.0f, false);
        [SerializeField]
        private BezierParam penetrationDistance = new BezierParam(0.1f, 0.2f, true, 0.0f, false);
        [SerializeField]
