...
namespace MagicaCloth
{
    ...
    public static class EditorInspectorUtility
    {
        ...
        //===============================================================================
        public static bool WorldInfluenceInspector(SerializedProperty cparam)
        {
            EditorGUI.BeginChangeCheck();
        ...
        public static bool DistanceDisableInspector(SerializedProperty cparam)
        {
            EditorGUI.BeginChangeCheck();
        ...
        {
            return MinMaxCurveInspector("Radius", "Radius", cparam.FindPropertyRelative("radius"), 0.01f, 0.1f);
        }
        ...
        public static bool TriangleBendInspector(SerializedProperty cparam)
        {
            return UseMinMaxCurveInspector("Triangle Bend", cparam.FindPropertyRelative("useTriangleBend"), "Bend Power", cparam.FindPropertyRelative("triangleBend"), 0.0f, 1.0f);
        }
        ...
        public static bool ClampRotationInspector(SerializedProperty cparam)
        {
            EditorGUI.BeginChangeCheck();
        ...
        public static bool CollisionInspector(SerializedProperty cparam)
        {
            EditorGUI.BeginChangeCheck();
        ...
        public static bool PenetrationInspector(SerializedObject team, SerializedProperty cparam)
        {
            EditorGUI.BeginChangeCheck();
        ...
        public static bool ClampDistanceInspector(SerializedProperty cparam)
        {
            EditorGUI.BeginChangeCheck();
        ...
        public static bool RestoreDistanceInspector(SerializedProperty cparam)
        {
            EditorGUI.BeginChangeCheck();
        ...
        public static bool FullSpringInspector(SerializedProperty cparam)
        {
            EditorGUI.BeginChangeCheck();
        ...
        public static bool SimpleSpringInspector(SerializedProperty cparam)
        {
            EditorGUI.BeginChangeCheck();
        ...
        public static bool AdjustRotationInspector(SerializedProperty cparam)
        {
            EditorGUI.BeginChangeCheck();
            ...
            Foldout(title, StaticStringBuilder.ToString(),
                () =>
                {
                    EditorGUI.BeginDisabledGroup(!useAdjustRotation.boolValue);
        ...
        public static bool ClampPositionInspector(SerializedProperty cparam, bool full)
        {
            EditorGUI.BeginChangeCheck();
        ...
        public static bool RotationInterpolationInspector(SerializedProperty cparam)
        {
            EditorGUI.BeginChangeCheck();
