...
namespace MagicaCloth
{
    ...
    public class PhysicsManagerCompute : PhysicsManagerAccess
    {
        ...
        public override void Create()
        {
            ...
            //Penatration = new ColliderPenetrationConstraint(); // この位置にあることが重要
            ...
            // 移動制限2
            //Penetration = new ColliderPenetrationConstraint(); // この位置にあることが重要
            //constraints.Add(Penetration);
        ...
        public void UpdateStartSimulation(UpdateTimeManager update)
        {
            ...
            if (Team.ActiveTeamCount > 0)
            {
                ...
                // 物理更新後ワーカー処理
                MasterJob = LineWorker.PostUpdate(MasterJob); // ラインの回転調整(Adjust Line)
